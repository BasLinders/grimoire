...
| **Training UI** | Gradio app: Preprocess, Pre-train (size presets, gradient checkpointing), Fine-tune, Ingest, Chat (int8 toggle, adaptive temperature, retrieval controls), Scale, Evaluate tabs | ✓ done |
