...
Usage
-----
    python scripts/scrape/scrape_internet_archive_magazines.py
    python scripts/scrape/scrape_internet_archive_magazines.py --magazine dragon --limit 30
    python scripts/scrape/scrape_internet_archive_magazines.py --out data/corpus/saga/ --delay 2.5
