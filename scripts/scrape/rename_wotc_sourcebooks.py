...
Usage
-----
    python scripts/scrape/rename_wotc_sourcebooks.py --dry-run   # preview only
    python scripts/scrape/rename_wotc_sourcebooks.py              # actually rename
    python scripts/scrape/rename_wotc_sourcebooks.py --corpus-dir data/corpus/saga/ --prefix wotc_book_
"""
