...
Usage
-----
    python scripts/scrape/scrape_arxiv.py
    python scripts/scrape/scrape_arxiv.py --group math --max-papers 50000
    python scripts/scrape/scrape_arxiv.py --start-year 2010 --output data/corpus/saga/
