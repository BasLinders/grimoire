...
Usage
-----
    python scripts/scrape/scrape_stackexchange_rpg.py
    python scripts/scrape/scrape_stackexchange_rpg.py --out data/corpus/saga --min-score 2
    python scripts/scrape/scrape_stackexchange_rpg.py --cache /tmp/se_dump --chunk 500
