...
Usage
-----
    python scripts/scrape/scrape_gutenberg_catalog.py
    python scripts/scrape/scrape_gutenberg_catalog.py --max-books 300
    python scripts/scrape/scrape_gutenberg_catalog.py --keywords "mythology,folklore"
    python scripts/scrape/scrape_gutenberg_catalog.py --refresh-catalog
...
def scrape(
    ...
    print(
        ...
        'python scripts/corpus/dedup_corpus.py --corpus-dir data/corpus/ '
