...
Generalizes ``scripts/scrape/scrape_stackexchange_rpg.py`` (which is hardcoded to
...
examples (see scripts/finetune/data/general_conversations.jsonl, 64
...
-----
    ...
    python scripts/scrape/scrape_stackexchange.py --site travel --out data/corpus/general_qa
    python scripts/scrape/scrape_stackexchange.py --site skeptics --min-score 2
