...
Usage
-----
    python scripts/scrape/scrape_5etools.py
    python scripts/scrape/scrape_5etools.py --out data/corpus/saga --categories spells bestiary
    python scripts/scrape/scrape_5etools.py --cache /tmp/5etools_src --chunk 500
