...
Usage
-----
    python scripts/scrape/scrape_fandom_wiki.py
    python scripts/scrape/scrape_fandom_wiki.py --output data/corpus/saga/ --delay 0.5
    python scripts/scrape/scrape_fandom_wiki.py --max-articles 500
