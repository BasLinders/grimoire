...
Usage
-----
    python scripts/scrape/scrape_open5e.py
    python scripts/scrape/scrape_open5e.py --output data/corpus/saga/ --delay 0.3
    ...
    page count:
    python scripts/scrape/scrape_open5e.py --endpoints spells monsters --document-slug wotc-srd
