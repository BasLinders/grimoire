...
Usage
-----
    python scripts/scrape/scrape_wikipedia.py
    python scripts/scrape/scrape_wikipedia.py --output data/corpus/saga/ --depth 2
    python scripts/scrape/scrape_wikipedia.py --group math --max-articles 2000
    python scripts/scrape/scrape_wikipedia.py --group dnd
