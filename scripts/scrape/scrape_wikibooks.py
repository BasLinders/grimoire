...
Usage
-----
    python scripts/scrape/scrape_wikibooks.py
    python scripts/scrape/scrape_wikibooks.py --output data/corpus/saga/ --depth 2
    python scripts/scrape/scrape_wikibooks.py --group math --max-pages 3000
