...
auto-derived dataset (e.g. scripts/finetune/build_finetune_data_from_qa.py's output)
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument(
        "--data", default="scripts/finetune/data/saga_v1.jsonl",
        help="Path to the JSONL fine-tuning dataset (default: scripts/finetune/data/saga_v1.jsonl).",
    )
    parser.add_argument(
