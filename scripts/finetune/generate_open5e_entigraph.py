...
-----
    ...
    python scripts/finetune/generate_open5e_entigraph.py --categories monster_condition class_spell
    python scripts/finetune/generate_open5e_entigraph.py --max-pairs-per-category 200 --seed 1
    python scripts/finetune/generate_open5e_entigraph.py --document-slug ""  # every Open5e document, unfiltered
