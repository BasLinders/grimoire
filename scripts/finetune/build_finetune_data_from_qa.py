...
scripts/corpus/clean_stackexchange_markup.py strips exactly those markers (they
...
dent across it -- see scripts/train/finetune_saga.py's own docstring for guidance.)
...
def main(argv: list[str] | None = None) -> None:
    ...
    if not pairs:
        raise ValueError(
            ...
            "cleaned by scripts/corpus/clean_stackexchange_markup.py, its structural "
