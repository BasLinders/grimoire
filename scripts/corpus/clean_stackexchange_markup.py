...
``scripts/scrape/scrape_stackexchange_rpg.py`` writes each Q&A pair as:
...
(used by ``scripts/finetune/build_finetune_data_from_qa.py`` and ``embed_tune.py``'s
...
Usage
-----
    python scripts/corpus/clean_stackexchange_markup.py --dry-run
    python scripts/corpus/clean_stackexchange_markup.py
"""
