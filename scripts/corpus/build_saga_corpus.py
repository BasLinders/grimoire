...
from scripts/references/ into the same output directory.
...
-----
    ...
    python scripts/corpus/build_saga_corpus.py --output-dir path/to/corpus/
    python scripts/corpus/build_saga_corpus.py --skip-download   # only copy references
