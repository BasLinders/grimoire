...
Usage
-----
    python scripts/corpus/score_corpus_quality.py --corpus-dir data/corpus/saga/
    python scripts/corpus/score_corpus_quality.py --corpus-dir data/corpus/saga/ --report quality_report.jsonl
    python scripts/corpus/score_corpus_quality.py --corpus-dir data/corpus/saga/ --min-chars 500
"""
