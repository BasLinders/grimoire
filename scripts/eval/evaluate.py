...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Path to a JSONL quiz file (for quiz eval). "
             "Defaults to scripts/eval/data/saga_quiz.jsonl when it exists.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="Retrieval embedding backend (default: lexical). 'model' uses the "
             ...
             "scripts/retrieval/embed_tune.py (requires --lora). The adapter is applied to a separate "
    ...
    parser.add_argument(
        ...
        help="Path to a .lora file from scripts/retrieval/embed_tune.py. Required when --encoder lora.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="Path to a .lora file from grimoire_ai.llm.training.finetune's "
             "--lora-rank generation fine-tuning (NOT scripts/retrieval/embed_tune.py's "
